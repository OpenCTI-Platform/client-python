...
class OpenCTIApiClient:
    ...
    def check_existing_stix_domain_entity(self, stix_id=None, name=None, type=None):
        ...
        if stix_id is not None:
            object_result = self.get_stix_entity_by_stix_id(stix_id)
    ...
    def get_stix_entity_by_stix_id(self, stix_id):
        query = """
            query StixEntity($stix_id: String, $isStixId: Boolean) {
                stixEntity(id: $stix_id, isStixId: $isStixId) {
                  id
                  entity_type
                }
            }
        """
        result = self.query(query, {'stix_id': stix_id, 'isStixId': True})
